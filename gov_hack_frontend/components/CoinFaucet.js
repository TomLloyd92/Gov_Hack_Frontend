    ...
    <div className="rounded-lg">
        <div className="bg-[#8632e6] rounded-lg w-96">
            ...
            <div className="px-10 pt-6 mb-10 text-center">
                ...
                <div className="pt-8">
                    <input class="bg-[#e033e7] rounded w-full py-2 px-4 text-black text-center leading-tight focus:outline-none focus:bg-white focus:border-purple-500" id="" type="" placeholder="Enter Amount of META"></input>
                </div>
            </div>
            <button
